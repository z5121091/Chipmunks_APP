        ...
        >
          ...
          {items.map((item) => (
            <TouchableOpacity
              ...
              style={[
                styles.wheelItem,
                selectedValue === item && styles.wheelItemSelected,
              ]}
        ...
        <View style={styles.container}>
          <TouchableOpacity activeOpacity={1}>
            ...
            <View style={styles.dateRangeDisplay}>
              ...
              >
                <Text style={[styles.dateTabLabel, activeTab === 'start' && styles.dateTabLabelActive]}>
                  开始日期
                </Text>
                <Text style={[styles.dateTabValue, activeTab === 'start' && styles.dateTabValueActive]}>
              ...
              >
                <Text style={[styles.dateTabLabel, activeTab === 'end' && styles.dateTabLabelActive]}>
                  结束日期
                </Text>
                <Text style={[styles.dateTabValue, activeTab === 'end' && styles.dateTabValueActive]}>
