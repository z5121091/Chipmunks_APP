...
export default function InventoryBindingScreen() {
  ...
  const handleImportFromExcel = async () => {
    ...
    try {
      ...
      // 批量导入
      const importCount = await importInventoryBindings(bindingsToImport);
      alert.showSuccess(`导入成功！\n新增 ${importCount} 条绑定\n更新 ${bindingsToImport.length - importCount} 条绑定`);
      loadBindings();
    } catch (error) {
          ...
          <>
            ...
            <View style={styles.topSection}>
              ...
              <View style={styles.actionButtons}>
                <TouchableOpacity style={styles.actionBtn} onPress={handleExportTemplate} activeOpacity={0.7}>
                  <Feather name="file-text" size={14} color={theme.textSecondary} />
                  <Text style={styles.actionBtnText}>模板</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionBtn} onPress={handleExportToExcel} activeOpacity={0.7}>
