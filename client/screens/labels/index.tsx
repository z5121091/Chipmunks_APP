    ...
    <Screen backgroundColor={theme.backgroundRoot} statusBarStyle={isDark ? 'light' : 'dark'}>
      ...
      <View style={styles.searchContainer}>
        ...
        <View style={styles.filterTabs}>
          ...
          <TouchableOpacity
            style={[styles.filterTab, filterType === 'shipped' && styles.filterTabActiveShipped]}
            onPress={() => setFilterType('shipped')}
          >
          ...
          <TouchableOpacity
            style={[styles.filterTab, filterType === 'remaining' && styles.filterTabActiveRemaining]}
            onPress={() => setFilterType('remaining')}
          >
      ...
      {filteredRecords.length > 0 && (
        <View style={styles.batchBar}>
          <TouchableOpacity
            style={[styles.checkbox, (isAllSelected || isPartialSelected) && styles.checkboxChecked]}
